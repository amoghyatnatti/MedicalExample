...
namespace MedicalExample.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProviderId,FirstName,LastName,Specialty")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProviderId,FirstName,LastName,Specialty")] Provider provider)
        {
